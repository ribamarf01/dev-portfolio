...
const Header = () => {
  ...
  <header className={`${styles.glassEffect} w-full h-16 bg-gray-400 bg-opacity-40 flex items-center justify-between fixed z-50`}>
    ...
    <div className={`text-rhythm md:text-3xl text-2xl font-pixellari flex md:flex-row flex-col md:static ${openMenu ? 'absolute' : 'hidden'} md:top-0 top-16 md:gap-8 mr-4 text-center md:w-auto w-full md:bg-transparent md:backdrop-blur-0 md:shadow-none ${openMenu ? styles.glassEffectMenu : ''}`}>
